...
The base-swap-specific rollback shape (restore_bundle call contract,
split-brain fix, marker + state cleanup) has no dedicated suite currently —
this file's rollback coverage is scoped to the config-only 8-step path
listed above.
"""
