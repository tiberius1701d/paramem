...
# archive.experiments.test14 imports gpu_guard transitively via experiments.utils.gpu_guard.
...
def _make_fill_state(
    ...
    from archive.experiments.test14 import EpochProbeState
...
class TestComputeRoundMetrics:
    def test_clean_round_no_touchup(self):
        ...
        from archive.experiments.test14 import compute_round_metrics
...
class TestEvaluate14bPassFail:
    ...
    def test_pass_all_criteria_met(self):
        ...
        from archive.experiments.test14 import evaluate_14b_pass_fail
...
class TestDecidePreWinner:
    ...
    def test_winner_picked_from_single_passing_variant(self, tmp_path):
        ...
        from archive.experiments.test14 import decide_pre_winner
...
class TestLoadOrWriteRunConfig:
    ...
    def test_write_then_read_parity(self, tmp_path):
        ...
        from archive.experiments.test14 import load_or_write_run_config
...
class TestRunRoundRetentionProbeGcGuard:
    ...
    def test_gc_reenabled_on_exception(self, tmp_path):
        ...
        from archive.experiments.test14 import run_round_retention_probe

        model = self._make_model_mock(is_gc_enabled=True)
        tokenizer = MagicMock()

        with patch(
            "archive.experiments.test14.evaluate_indexed_recall",
...
class TestSafeProbeGcGuard:
    ...
    def test_safe_probe_reenables_gc_on_exception(self):
        ...
        from archive.experiments.test14 import _safe_probe
    ...
    def test_safe_probe_returns_result_and_reenables(self):
        ...
        with patch("archive.experiments.test14.evaluate_indexed_recall", return_value=expected):
...
class TestCheckPauseWritesPausedJson:
    ...
    def test_paused_json_written_before_exit(self, tmp_path):
        ...
        from archive.experiments.test14 import _check_pause

        pause_file = tmp_path / ".training_pause"
        pause_file.touch()

        with patch("archive.experiments.test14.PAUSE_FILE", pause_file):
...
class TestLoadPhaseAFromExisting:
    ...
    def test_phase_a_reused_json_written(self, tmp_path):
        ...
        from archive.experiments.test14 import load_phase_a_from_existing
        ...
        with patch("archive.experiments.test14.PeftModel") as mock_peft:
...
class TestExitIfPausedMidPhase:
    ...
    def test_no_action_on_natural_convergence(self, tmp_path):
        ...
        from archive.experiments.test14 import EpochProbeState, _exit_if_paused_mid_phase
...
class TestAggregateMultiSeedPhaseC:
    ...
    def test_aggregate_writes_per_variant_summary(self, tmp_path):
        from archive.experiments.test14 import aggregate_multi_seed_phase_c
