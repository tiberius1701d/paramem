"""Non-GPU contract tests for archive/experiments/test15_retention_multiseed.py.
...
from archive.experiments.test15_retention_multiseed import (  # noqa: E402, I001
...
class TestPhaseBuilderParity:
    ...
    def _get_test13_builders(self):
        ...
        from archive.experiments.test13_journal_scaffold import (  # noqa: I001
...
class TestRunConfig:
    ...
    def test_find_latest_run_dir_returns_newest_dir(self, tmp_path):
        ...
        import archive.experiments.test15_retention_multiseed as t15_mod
...
class TestPhaseAResume:
    ...
    def test_find_latest_checkpoint_skips_partial(self, tmp_path):
        ...
        ``archive/experiments/test15_retention_multiseed.py:289-293``: a SIGKILL / bugcheck
    ...
    def test_run_phase_accepts_resume_from_checkpoint(self):
        ...
        from archive.experiments.test15_retention_multiseed import _run_phase
    ...
    def test_phase_a_call_site_pattern(self, tmp_path, monkeypatch):
        ...
        def _fake_run_phase(**kwargs):
            ...
            from archive.experiments.test15_retention_multiseed import EpochProbeState
