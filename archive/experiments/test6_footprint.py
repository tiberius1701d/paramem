...
from archive.experiments.legacy_harness import (  # noqa: E402
    distill_qa_pairs,
    train_indexed_keys,
)
from archive.legacy_qa import assign_keys, build_registry  # noqa: E402
...
def measure_inference_latency(model, tokenizer, quads, registry, adapter_name, num_queries=20):
    ...
    from archive.legacy_qa import probe_key
